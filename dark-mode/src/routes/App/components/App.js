...
function App() {
    ...
    return (
        <div className={`app ${toggle ? ' dark-mode' : ""}`}>
            <div className="level">
                <div>
                ...
                <button className="app__dark-mode-btn icon level-right" onClick={() =>setToggle(!toggle)}>
                    <FontAwesomeIcon icon={faMoon} style={{color: toggle ? "#FFA500":"black"}} />
                </button>
